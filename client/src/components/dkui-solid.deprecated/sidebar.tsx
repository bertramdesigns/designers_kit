// Code from solidui/sidebar.tsx
// modified to work with titlebar component
...
import { Sheet, SheetContent } from "~/components/solidui/sheet";
import { Skeleton } from "~/components/solidui/skeleton";
import { TextField, TextFieldInput } from "~/components/solidui/text-field";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "~/components/solidui/tooltip";
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        class={cn(
          "group/sidebar-wrapper flex h-full w-full text-sidebar-foreground",
          local.class
        )}
        {...others}
      >
