...
type TableRowProps = ComponentProps<"tr"> & { hover?: boolean };

const TableRow: Component<TableRowProps> = (rawProps) => {
  const props = mergeProps<TableRowProps[]>({ hover: true }, rawProps);
